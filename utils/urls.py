...
urlpatterns = [
    ...
    path('pending-mail-list/', views.PendingMail, name='pending_mails'),
    ...
    path('project-plan-update-true/<int:id>/', views.UpdateProjectPlanToComplate, name='update_project_plan_true'),
